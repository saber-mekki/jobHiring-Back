...
import { addInterviewController, getInterviewController } from "../../controllers/interview";
 ...
 *
 */
router2.route("/interviews").get(getInterviewController);
 ...
 */
router2.route("/addInterview").post(addInterviewController);
